...
$jscomp.polyfill("Promise", function (a) {
    function e() { this.batch_ = null } function f(c) { return c instanceof b ? c : new b(function (a, d) { a(c) }) } if (a && !$jscomp.FORCE_POLYFILL_PROMISE) return a; e.prototype.asyncExecute = function (c) { if (null == this.batch_) { this.batch_ = []; var a = this; this.asyncExecuteFunction(function () { a.executeBatch_() }) } this.batch_.push(c) }; var g = $jscomp.global.setTimeout; e.prototype.asyncExecuteFunction = function (c) { g(c, 0) }; e.prototype.executeBatch_ = function () {
        for (; this.batch_ && this.batch_.length;) {
            var c =
                this.batch_; this.batch_ = []; for (var a = 0; a < c.length; ++a) { var d = c[a]; c[a] = null; try { d() } catch (n) { this.asyncThrow_(n) } }
        } this.batch_ = null
    }; e.prototype.asyncThrow_ = function (c) { this.asyncExecuteFunction(function () { throw c; }) }; var b = function (c) { this.state_ = 0; this.result_ = void 0; this.onSettledCallbacks_ = []; var a = this.createResolveAndReject_(); try { c(a.resolve, a.reject) } catch (d) { a.reject(d) } }; b.prototype.createResolveAndReject_ = function () {
        function a(a) { return function (c) { d || (d = !0, a.call(b, c)) } } var b = this, d = !1;
        return { resolve: a(this.resolveTo_), reject: a(this.reject_) }
    }; b.prototype.resolveTo_ = function (a) { if (a === this) this.reject_(new TypeError("A Promise cannot resolve to itself")); else if (a instanceof b) this.settleSameAsPromise_(a); else { a: switch (typeof a) { case "object": var c = null != a; break a; case "function": c = !0; break a; default: c = !1 }c ? this.resolveToNonPromiseObj_(a) : this.fulfill_(a) } }; b.prototype.resolveToNonPromiseObj_ = function (a) {
        var c = void 0; try { c = a.then } catch (d) { this.reject_(d); return } "function" == typeof c ?
...
~function () {
    function a(a, b, c) { return function () { c.canScrollPrev() ? a.removeAttribute("disabled") : a.setAttribute("disabled", "disabled"); c.canScrollNext() ? b.removeAttribute("disabled") : b.setAttribute("disabled", "disabled") } } function e(a, b, c) {
        ...
        return new Promise(function (e, h) {
            var f = b.querySelector(".embla"), g = b.getAttribute("id"), l = f.querySelector(".embla__viewport"); h = f.querySelector(".embla__button--prev"); f = f.querySelector(".embla__button--next"); if (-1 === d.findIndex(function (a) { return a.carouselId === g })) {
        ...
        if (!r(a.target).hasClass("mbr-embla") || n) return Promise.resolve(); var d = a.target.getAttribute("id"); b(d); var h = g(a.target.querySelector(".embla")), t = c(h, p), k = Object.assign(h, t); k.draggable = !1; return f(a.target, k).then(function (a) {
            a.reInit(k); e(d, k.autoPlay, k.autoPlayInterval);
            n = !0; setTimeout(function () { n = !1 }, 0)
        })
    }).on("delete.cards", function (a) { a = a.target.getAttribute("id"); b(a) }).on("changeParameter.cards", function (a, d, q) { if (r(a.target).hasClass("mbr-embla")) { var h = a.target.getAttribute("id"), k = g(a.target.querySelector(".embla")), l = c(k, p); k = Object.assign(k, l); switch (d) { case "loop": p.loop = q ? !0 : !1; break; case "autoplay": p.autoPlay = q; break; case "interval": p.autoPlayInterval = +q }b(h); k.draggable = !1; f(a.target, k); e(h, k.autoPlay, k.autoPlayInterval) } }); else "undefined" === typeof window.initCarouseMultiplePlugin &&
